...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'cursing-around:move-last-cursor-up-in-screen': () => this.moveLastCursorInScreen(this.moveCursorInScreen,this.positionUpInScreen)
    }));
  },
  ...
  moveCursorInScreen(cursor,position) {
